              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{ url('admin/update-vendor-details/business') }}" method="post" enctype="multipart/form-data">@csrf
                    ...
                    <div class="form-group">
                      <label for="shop_state">Shop Barangay</label>
                      <input type="text" class="form-control" id="shop_state" placeholder="Enter Shop Barangay" name="shop_state" @if(isset($vendorDetails['shop_state'])) value="{{ $vendorDetails['shop_state'] }}" @endif>
                    </div>
                    <div class="form-group">

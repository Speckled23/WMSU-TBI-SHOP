         ...
         <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <div class="all-information-wrapper">
                  ...
                  <span class="getAttributePrice">
                     ...
                     <div class="price-template">
                        <div class="item-new-price">
                           {{$_GET['cy']}} {{ number_format(round($getDiscountPrice / $getCurrency['exchange_rate'], 2), 2, '.', ',') }}
                        </div>
                        <div class="item-old-price">
                           {{$_GET['cy']}} {{ number_format(round($productDetails['product_price'] / $getCurrency['exchange_rate'], 2), 2, '.', ',') }}
                        </div>
                     </div>
                     @else
                     <div class="price-template">
                     ...
                     <div class="price-template">
                        <div class="item-new-price">
                           PHP {{ number_format($getDiscountPrice, 2, '.', ',') }}
                        </div>
                        <div class="item-old-price">
                           PHP {{ number_format($productDetails['product_price'], 2, '.', ',') }}
                        </div>
                     </div>
                     @else
                     <div class="price-template">
               ...
               <div class="section-4-sku-information u-s-p-y-14">
                  ...
                  <div class="left">
                     <span>Only:</span>
                     <span>{{ $totalStock }} pieces left</span>
                  </div>
                  @endif
               </div>
                  ...
                  <div class="section-5-product-variants u-s-p-y-14">
                     ...
                     <div class="sizes u-s-m-b-11" style="margin-top: 20px;">
                        ...
                        <div class="size-variant select-box-wrapper">
                           ...
                           @php
                           $formattedPrice = isset($_GET['cy']) ? number_format(round($attribute['size'] / $getCurrency['exchange_rate'], 2), 2, '.', ',') : number_format($attribute['size'], 2, '.', ',');
                           @endphp
                           <option value="{{ $attribute['size'] }}">{{ $_GET['cy'] ?? 'PHP' }} {{ $formattedPrice }}</option>
                           @endforeach
                           </select>
                        </div>
                     </div>
                     ...
                     <div class="item">
                        ...
                        <div class="item-content">
                           ...
                           <span class="getAttributePrice">
                              @if($getDiscountPrice>0)
                              <div class="price">
                                 <h4>{{$_GET['cy']}} {{ number_format(round($getDiscountPrice/$getCurrency['exchange_rate'],2), 2, '.', ',') }}</h4>
                              </div>
                              <div class="original-price">
                                 <span>Original Price:</span>
                                 <span>{{$_GET['cy']}} {{ number_format(round($productDetails['product_price']/$getCurrency['exchange_rate'],2), 2, '.', ',') }}</span>
                              </div>
                              @else
                              <div class="price">
                                 <h4>{{$_GET['cy']}} {{ number_format(round($productDetails['product_price']/$getCurrency['exchange_rate'],2), 2, '.', ',') }}</h4>
                              </div>
                              @endif  
                           </span>
                           @else
                           <span class="getAttributePrice">
                              @if($getDiscountPrice>0)
                              <div class="price">
                                 <h4>PHP {{ number_format($getDiscountPrice, 2, '.', ',') }}</h4>
                              </div>
                              <div class="original-price">
                                 <span>Original Price:</span>
                                 <span>PHP {{ number_format($productDetails['product_price'], 2, '.', ',') }}</span>
                              </div>
                              @else
                              <div class="price">
                                 <h4>PHP {{ number_format($productDetails['product_price'], 2, '.', ',') }}</h4>
                              </div>
                              @endif  
                           </span>
                           @endif
                     ...
                     <div class="item">
                        ...
                        <div class="item-content">
                           ...
                           <div class="price-template">
                              ...
                              <div class="item-old-price">
                                 PHP{{ number_format($product['product_price'], 2, '.', ',') }}
                              </div>
                           </div>
                           @else
                           <div class="price-template">
